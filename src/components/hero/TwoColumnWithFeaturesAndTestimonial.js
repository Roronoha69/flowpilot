...
const Row = tw.div`flex flex-col lg:flex-row justify-between items-center lg:pt-16 max-w-screen-2xl mx-auto sm:px-32`;
const Column = tw.div``;
...
export default ({
  heading = "Automatically Qualify and Close Instagram Leads With AI For FREE",
